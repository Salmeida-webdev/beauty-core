...
export class BackupController {
  ...
  @Get('status')
  @ApiOperation({
    summary: 'Consultar status operacional de backup e recovery',
  })
  ...
  @ApiOkResponse({
    description: 'Rotina PostgreSQL registrada em modo seguro.',
  })
  executarPostgres() {
  ...
  @ApiOkResponse({
    description: 'Rotina de uploads registrada em modo seguro.',
  })
  executarUploads() {
