# Inventário ESLint dos testes ativos — B172

- Data: 2026-09-22
- Baseline: B170 (`chat-b170-backend-active-tests-eslint-inventory-20260922.md`).
...
`test/e2e/auditoria.e2e-spec.ts` — 6 erros e 3 avisos.

Empate seguinte por erros: `test/unit/agendamentos-concurrency.spec.ts` — 6 erros e 0 avisos.
