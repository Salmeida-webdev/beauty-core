# Inventário ESLint atualizado — testes ativos do backend

- Data: 2026-09-21 17:04:38 -03:00
- Escopo: arquivos TypeScript sob ``test/``; inclui specs e seus helpers/setup/seeds TypeScript.
- Exclusões: ``node_modules``, ``coverage`` e ``dist``.
- ESLint: ``test/**/*.ts --format json --no-cache`` com heap de 6144 MB; sem ``--fix``.
- Arquivos candidatos encontrados por ``rg --files``: 70
- Resultados individuais processados pelo ESLint: 70
- Verificação de cardinalidade: PASS — contagens iguais
- Exit code ESLint: 1
- Duração ESLint: 23.9 s
- Diagnósticos totais: 383 (244 erros, 139 avisos)
- Arquivos com diagnósticos: 39
- Arquivos sem diagnósticos: 31
...
| `@typescript-eslint/no-require-imports` | 37 | 0 |
| `@typescript-eslint/no-unsafe-argument` | 0 | 139 |
| `@typescript-eslint/no-unsafe-assignment` | 63 | 0 |
| `@typescript-eslint/no-unsafe-call` | 47 | 0 |
| `@typescript-eslint/no-unsafe-function-type` | 7 | 0 |
| `@typescript-eslint/no-unsafe-member-access` | 66 | 0 |
| `@typescript-eslint/no-unsafe-return` | 3 | 0 |
| `@typescript-eslint/no-unused-vars` | 3 | 0 |
| `@typescript-eslint/restrict-plus-operands` | 2 | 0 |
| `@typescript-eslint/unbound-method` | 4 | 0 |
| `no-empty` | 10 | 0 |

## Contagem por arquivo e regra

| Arquivo | Erros | Avisos | Regras e contagens |
|---|---:|---:|---|
| `test/app.e2e-spec.ts` | 0 | 0 | — |
| `test/e2e/auditoria.e2e-spec.ts` | 6 | 3 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 3); @typescript-eslint/no-unsafe-assignment (erros 1, avisos 0); @typescript-eslint/no-unsafe-call (erros 1, avisos 0); @typescript-eslint/no-unsafe-member-access (erros 3, avisos 0) |
| `test/e2e/auth-admin.e2e-spec.ts` | 4 | 10 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 10); @typescript-eslint/no-unsafe-member-access (erros 3, avisos 0) |
| `test/e2e/auth-cliente.e2e-spec.ts` | 15 | 10 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 10); @typescript-eslint/no-unsafe-assignment (erros 2, avisos 0); @typescript-eslint/no-unsafe-call (erros 1, avisos 0); @typescript-eslint/no-unsafe-member-access (erros 10, avisos 0); @typescript-eslint/restrict-plus-operands (erros 1, avisos 0) |
| `test/e2e/cliente-area.e2e-spec.ts` | 1 | 3 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 3) |
| `test/e2e/health.e2e-spec.ts` | 1 | 6 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 6) |
| `test/e2e/lgpd-runtime.e2e-spec.ts` | 0 | 4 | @typescript-eslint/no-unsafe-argument (erros 0, avisos 4) |
...
| `test/e2e/multiempresa.e2e-spec.ts` | 10 | 6 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 6); @typescript-eslint/no-unsafe-assignment (erros 3, avisos 0); @typescript-eslint/no-unsafe-call (erros 2, avisos 0); @typescript-eslint/no-unsafe-member-access (erros 4, avisos 0) |
| `test/e2e/queues.e2e-spec.ts` | 1 | 4 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 4) |
...
| `test/e2e/roles.e2e-spec.ts` | 1 | 3 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 3) |
| `test/e2e/scheduler.e2e-spec.ts` | 1 | 3 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 3) |
| `test/e2e/sessoes.e2e-spec.ts` | 1 | 7 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 7) |
| `test/e2e/super-admin.e2e-spec.ts` | 1 | 5 | @typescript-eslint/no-require-imports (erros 1, avisos 0); @typescript-eslint/no-unsafe-argument (erros 0, avisos 5) |
...
| `test/e2e/uploads.e2e-spec.ts` | 13 | 8 | @typescript-eslint/no-unsafe-argument (erros 0, avisos 8); @typescript-eslint/no-unsafe-assignment (erros 3, avisos 0); @typescript-eslint/no-unsafe-member-access (erros 10, avisos 0) |
| `test/e2e/uploads-strict-roundtrip.e2e-spec.ts` | 0 | 1 | @typescript-eslint/no-unsafe-argument (erros 0, avisos 1) |
| `test/e2e/whatsapp-queue-demo.e2e-spec.ts` | 0 | 1 | @typescript-eslint/no-unsafe-argument (erros 0, avisos 1) |
...
- `test/e2e/auditoria.e2e-spec.ts`:22:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/auditoria.e2e-spec.ts`:38:46 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/auth-admin.e2e-spec.ts`:53:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/auth-admin.e2e-spec.ts`:70:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/auth-admin.e2e-spec.ts`:79:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/auth-admin.e2e-spec.ts`:95:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/auth-cliente.e2e-spec.ts`:63:7 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
- `test/e2e/auth-cliente.e2e-spec.ts`:73:7 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/auth-cliente.e2e-spec.ts`:94:7 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/auth-cliente.e2e-spec.ts`:107:7 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/auth-cliente.e2e-spec.ts`:125:7 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/cliente-area.e2e-spec.ts`:17:33 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/health.e2e-spec.ts`:16:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/lgpd-runtime.e2e-spec.ts`:62:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/multiempresa.e2e-spec.ts`:21:39 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/multiempresa.e2e-spec.ts`:49:39 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/queues.e2e-spec.ts`:16:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/roles.e2e-spec.ts`:33:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/scheduler.e2e-spec.ts`:16:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/sessoes.e2e-spec.ts`:22:38 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
- `test/e2e/sessoes.e2e-spec.ts`:25:38 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/sessoes.e2e-spec.ts`:49:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/super-admin.e2e-spec.ts`:16:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/uploads-strict-roundtrip.e2e-spec.ts`:86:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
- `test/e2e/uploads.e2e-spec.ts`:33:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
- `test/e2e/uploads.e2e-spec.ts`:36:9 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
- `test/e2e/whatsapp-queue-demo.e2e-spec.ts`:47:36 — aviso, `@typescript-eslint/no-unsafe-argument`: Unsafe argument of type `INestApplication<any>` assigned to a parameter of type `INestApplication<Server>`.
...
`test/unit/micro-boost.coverage.spec.ts` — 21 erro(s), 3 aviso(s); maior contagem atual de erros.

## Integridade

- Nenhum arquivo de código foi alterado; nenhum ``--fix`` foi executado.
- Relatório anterior preservado: ``docs/chat-b/chat-b148-backend-active-tests-eslint-inventory-20260921.md``.
