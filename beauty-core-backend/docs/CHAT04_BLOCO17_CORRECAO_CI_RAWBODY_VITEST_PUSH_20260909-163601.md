...
Data da execucao: 2026-09-09 16:36:01 -03:00
...
- Alteracoes preservadas antes: 276
...
- Exit code: 1
- Comando: `C:\WINDOWS\system32\cmd.exe /d /c ""C:\Program Files\nodejs\npm.cmd" install --save-dev --save-exact vitest@4.1.11 @vitest/coverage-v8@4.1.11 --ignore-scripts --no-audit"`
```text
npm error Cannot read properties of null (reading 'edgesOut')
npm error A complete log of this run can be found in: C:\Users\cmted\AppData\Local\npm-cache\_logs\2026-09-09T19_36_03_418Z-debug-0.log
```

## Resultado: **NO-GO-CI-CORRECTION**
- Erro: Atualizacao seletiva do Vitest falhou (exit code 1).
npm error Cannot read properties of null (reading 'edgesOut')
npm error A complete log of this run can be found in: C:\Users\cmted\AppData\Local\npm-cache\_logs\2026-09-09T19_36_03_418Z-debug-0.log
